...
$extraname="깝쭉이"
extra "「회장님이랑 같은수업이라고? 약점이라도 잡은 것 아냐?」"
$extraname="여미새"
extra "「이번에 온 신입생 중에 청순한 여자애 있던데 걔랑 아는 사이야? 나 좀 소개시켜줘봐.」"
$extraname="오타쿠"
extra "「오이오이, [playername]쿤! 이 녀석 복학하니까 아예 하렘만드는 거야?. 거의 라노벨 급이야.」"
# 등장 : 주인공 : 왼쪽
m "「하아.. 아니라고... 아니라고.. 제발 다 나가줘 혼자있게」"
$extraname="친구들"
extra "넌 우리 연합을 배신했다!"
extra "이 기만자 녀석.."
# 퇴장 : 엑스트라 군중
...
menu:
   "{color=#066de2}Choice{/color}({color=#63a35c}\"윤미래\"{/color});":
    ...
    h1 "「이제 곧 점심이니 난 잠깐 숨 좀 돌리고 올게~ 오케이 이따 봐. 오 [playername] 아니야?!」"
    h1 "「무슨 일이야?」"
...
h1 "「잠만 여기에서 기다려 줄래?」"
m "나는 영문도 모른채 알겠다 대답을 하고 가만히 앉아있었다. 선배가 주위 눈치를 보고 있었다."
...
m "「이 티켓, 한정판 아니에요? 게다가 이거 요즘 핫한 가수 '김학인'도 오는 축제잖아요? 추첨 경쟁도 되게 빡셌는데.」"
...
m "갑자기 무언가 생각 났는지 가방에서 무언가를 꺼내었다."
h2 "「자요.」"
m "하린이가 내 앞으로 내민건… 이번에 새로 개장한 테마 파크 티켓이였다."
m "「이건 어떻게 구한거야??? 그리고 이 티켓은…」"
h2 "「잠시만요 선배. 일단 가격이야기는 제쳐두고, 이번에 선배와 같이 가고 싶어서 그래요. 이번주 토요일에 시간 되나요?」"
...
m "「친하게 지내던 사람들이 갑자기 예상치 못하는 행동을 한다고? 그럼 너한테 관심있는게 아닌지 생각해봐. 일단 행운을 빌게」"
...
menu:
        "{color=#066de2}Ending{/color}({color=#63a35c}\"윤미래\"{/color});":
            m "그래 미래 선배의 고백을 받아들이자. 나는 마음속으로 결정한 뒤 내일이 밝기를 기다렸다…."
...
# 등장 : 선배(mirae_sweat_general) : 가운데
            ...
            m "「선배, 선배는 저에게 정말 과분한 사람이라고 생각해요. 그래서 선배가 저에게 호감을 가져주신걸 정말 고맙게 생각해요」"
            m "「저도 용기를 한 번 내봤어요. 선배, 제가 정말 괜찮다면 한 번 만나주실래요?」"
            m "미래 선배는 나의 얼굴을 잠시동안 쳐다보더니 갑자기 눈물을 흘리기 시작하였다. 나는 조용히 선배를 안으면서 아무말도 하지 않았다. 한참 뒤 선배의 조용한 목소리가 들려왔다."
            h1 "「난 [playername]의 고백을 받아서… 너무 좋아…..」"
...
#------------- '2. 유하린' 을 고를경우 ------------------------------------------------------------------------------
           m "그래 하린이의 고백을 받아들이자. 나는 마음속으로 결정한 뒤 내일이 밝기를 기다렸다…."
# 배경 전환 : house_players -> (none)
           m "……………………….."
           m "…………………………"
# 배경 전환 : (none) -> house_players
