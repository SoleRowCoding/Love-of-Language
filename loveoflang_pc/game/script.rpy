...
label start:
    ...
    system ".\/nameset"
label namechk:
    $playername=renpy.input("Write your name(less than 5) :",length=4)
...
menu:
 ...
 "{color=#066de2}Say{/color}({color=#63a35c}\"제가 먼저 대답할께요. 정답은 이 박스에 있는 거죠?\"{/color});":
...
m "나는 깜짝놀라 500 국밥을 떨어뜨려 부술 뻔 했다."
m "다이소에 파는 박스 VR고글이 아니라 제대로된 VR기기였다."
...
menu:
   ...
   "{color=#066de2}Choice{/color}({color=#63a35c}\"유하린\"{/color});":
    ...
    hide extra2 with dissolve
    # 퇴장 : 엑스트라 군중
    m "예정에 없던 한 판을 바쁘게 준비하기 시작하였다."
    m "뒤를 돌아보니 사뿐사뿐 걸어오는 하린이가 보였다"
    # 등장 : 후배 츄리닝 기본 : 오른쪽
    show harin general at center with dissolve
    h2 "「선배! 저 왔어요!」"
...
m "여름방학이 물 흐르듯 빠르게 지나가고 벌써 2학기의 시작되었다."
...
#------------- '2. 유하린' 을 고를경우 ------------------------------------------------------------------------------
    "{color=#066de2}Ending{/color}({color=#63a35c}\"유하린\"{/color});":
        ...
        h2 "「...」"
        m "「내가 정말 잘못 생각하고 있던거지.\n만나보지도 못한 상황에 지레 겁먹고있었어」"
        m "「지금 내가 누리는 일상에 너무 심취해서, 지금을 지키고 싶어했던 것 같아」"
        m "「내가 새로운 결정을 했을 때 다른사람뿐 아니라\n하린이, 너까지 잃어버릴까봐.」"
