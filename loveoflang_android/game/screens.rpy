...
screen navigation():
    ...
    vbox:
        ...
        textbutton _("제작정보") action ShowMenu("about")
...
screen about():
    ...
    use game_menu(_("제작정보"), scroll="viewport"):

        style_prefix "about"

        vbox:
            label "Team SoleRowCoding"
            text _("김학인 Lead Developer")
            text _("공상현 Lead Artist")
            text _("이창근 Lead Writer")
            text _("이원진 Project Manager")
            text _("\n")

            label "언어의 사랑"
            text _("언어의 사랑이 이용한 타사, 타인의 저작물은 해당 저작물에 이미 부여된 라이센스를 따릅니다. Team SoleRowCoding에서 권리를 보유한 저작물은 {a=https://github.com/SoleRowCoding/Love-of-Language}SoleRowCoding/Love-of-Language 저장소{/a}에 동봉된 LICENSE 파일의 내용에 따라 라이센스를 적용합니다.")
            text _("\n")

            label "자체 보유 저작물"
            text _("아래에 기재하지 않은 모든 저작물은 Team SoleRowCoding에서 권리를 보유하고 있습니다.")
            text _("\n")
            ...
            label "배경그림"
            text _("학교 언어의사랑 동아리방 : {a=https://unsplash.com/photos/NEFgreoVtig}myHQ Workspaces{/a}")
            text _("학교 다른 동아리방 : {a=https://pixabay.com/images/id-4837911/}Chalo Garcia{/a}")
            text _("레스토랑 : {a=https://unsplash.com/photos/Ciqxn7FE4vE}Nick Karvounis{/a}")
            text _("\n")

            label "효과음"
            text _("Door Slam Sound : {a=https://www.youtube.com/watch?v=c9nJzXipETM}무료저작권세상{/a}")
            text _("Alarm1 : {a=https://freesound.org/s/250629/}kwahmah_02{/a}")
            text _("Analog Alarm Clock : {a=https://freesound.org/s/198841/}bone666138{/a}")
            text _("smartphone_vibrating_alarm_silent : {a=https://freesound.org/s/396130/}EricsSoundschmiede{/a}")
            text _("elevator 02 : {a=https://freesound.org/s/502339/}universodemalaonda{/a}")
            text _("05 Elevator Bing : {a=https://freesound.org/s/340750/}soundslikewillem{/a}")
            text _("3_tone_chime : {a=https://freesound.org/people/dudamix98/sounds/459547/}dudamix98{/a}")
            text _("\n")

            label "배경음악"
            text _("CUTIE KITTY - UmbrTone")
            text _("PUPPY LOVE - UmbrTone")
            text _("BELL SONG - UmbrTone")
            text _("SUPERCHARGED - UmbrTone")
            text _("Shimmering Shadows - noonsol")
            text _("MISSION POSSIBLE - UmbrTone")
            text _("ON THE ROAD - UmbrTone")
            text _("WARM_CREAM AND PUFF - UmbrTone")
            text _("starlight - noonsol")
            text _("dissociation - naoya sakamata")
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            #textbutton _("자동진행") action Preference("auto-forward", "toggle")
            #textbutton _("메뉴")
            imagebutton auto "gui/setting_%s.png" action ShowMenu()
